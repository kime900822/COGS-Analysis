...
+function ($) {
    ...
    $(function() {
        ...
        BJUI.setRegional('statusCode_503', 'HTTP status 503, the current server load is too large or is down for maintenance!')
		    ...
		    BJUI.setRegional('uititle', 'Analysis')
        ...
        $.validator && $.validator.config({
            // Custom rules
            rules: {
                digits: [/^\d+$/, 'please enter an integer']
                ,number: [/^[\-\+]?((([0-9]{1,3})([,][0-9]{3})*)|([0-9]+))?([\.]([0-9]+))?$/, 'Please enter a valid number']
                ,letters: [/^[a-z]+$/i, '{0} can only input letters']
                ,upletterandnumber: [/^[A-Z0-9]+$/, 'You can only enter uppercase letters and numbers']
                ,tel: [/^(?:(?:0\d{2,3}[\- ]?[1-9]\d{6,7})|(?:[48]00[\- ]?[1-9]\d{6}))$/, "Please fill in the valid telephone number"]
                ,mobile: [/^1[3-9]\d{9}$/, 'The phone number is not in the right format']
                ,email: [/^[\w\+\-]+(\.[\w\+\-]+)*@[a-z\d\-]+(\.[a-z\d\-]+)*\.([a-z]{2,4})$/i, "Please fill in the valid mailbox"]
                ...
                ,datetime: [/^\d{4}[\/\-](0?[1-9]|1[012])[\/\-](0?[1-9]|[12][0-9]|3[01])\s+(2[0123]|(1|0?)[0-9]){1}:([0-5][0-9]){1}:([0-5][0-9]){1}$/,
                            'Please enter the correct date and time, example: yyyy-MM-dd HH:mm:ss']
                ,IDcard: [/^\d{6}(19|2\d)?\d{2}(0[1-9]|1[012])(0[1-9]|[12]\d|3[01])\d{3}(\d|X)?$/, "Please fill in the correct ID number"]
                ,url: [/^(https?|s?ftp):\/\/\S+$/i, "Please fill in the valid URL"]
                ,zipcode: [/^\d{6}$/, "Please check the zip code format"]
                ,chinese: [/^[\u0391-\uFFE5]+$/, 'Please input Chinese']
                ,username: [/^\w{3,12}$/, 'Please enter 3-12 digits, letters, underscores']
                ,password: [/^[\S]{6,16}$/, "Please fill in 6-16 bit characters, not spaces"]
                ,pattern:function(element, params) {
                    if (!params) return true
                    
                    var date = element.value.parseDate(params)
                    
                    return (!date ? this.renderMsg('Wrong date and time format！', params) : true)
                }
            ...
            messages: {
                0: "Here",
                fallback: "The {0} format is incorrect",
                loading: "Verifying...",
                error: "Network anomaly",
                timeout: "request timeout",
                required: "{0} can't be empty",
                remote: "{0} has been used",
                integer: {
                    '*': "Please fill in the integers",
                    '+': "Please fill in the positive integer",
                ...
                match: {
                    ...
                    neq: "{0} and {1} can't be the same",
                    lt: "{0} must be less than {1}",
                    gt: "{0} must be greater than {1}",
                    lte: "{0} should not be greater than {1}",
                    gte: "{0} must not be less than {1}"
                },
                range: {
                    rg: "Please fill in the numbers from {1} to {2}",
                    gte: "Please fill in the number of not less than {1}",
                    lte: "Please fill in the maximum number of {1}",
                    gtlt: "Please fill in the numbers from {1} to {2}",
                    gt: "Please fill in the number greater than {1}",
                    lt: "Please fill in the number less than {1}"
                },
                checked: {
                    eq: "Please select the {1} item",
                    rg: "Please select {1} to {2} item",
                    gte: "Please select at least {1} item",
                    lte: "Please select the {1} item at most"
                },
                length: {
                    eq: "Please fill in {1} characters",
                    rg: "Please fill in {1} to {2} characters",
                    gte: "Please fill in at least {1} characters",
                    lte: "Please fill in {1} characters at most",
                    eq_2: "",
                    rg_2: "",
                    gte_2: "",
                    lte_2: ""
...
/* ========================================================================
 * B-JUI: bjui-contextmenu.js  V1.31
 * @author K'naan
...
/* ========================================================================
 * B-JUI: bjui-datepicker.js  V1.31
